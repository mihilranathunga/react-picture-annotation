...
import { Container, imgSdk, imgFile, pdfFile, pdfSdk } from './utils';
...
<Meta
  title="Advanced Cognite File Viewer"
...
Here is a demo of the more advanced case with editing enabled.
...
<ArgsTable of={CogniteFileViewer} />
